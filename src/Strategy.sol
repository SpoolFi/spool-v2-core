...
abstract contract Strategy is ERC20Upgradeable, SpoolAccessControllable, IStrategy {
    ...
    function doHardWork(
        ...
        // TODO: calculate/input base yield from last DHW till now
        // TODO: take SST fees from base yield

        int256 dhwYieldPercentage = _getYieldPercentage(0);

        dhwYieldPercentage += compound();
        // TODO: take SST fees from compounded rewards
        ...
        return DhwInfo({usdRouted: usdWorthDeposited, sharesMinted: sstsToMint, assetsWithdrawn: withdrawnAssets, yieldPercentage: dhwYieldPercentage, valueAtDhw: 0 /* TODO */});
    }
