...
// This is the same contract as EthenaStrategy.sol, but with ability to
// extract airdropped tokens.
contract EthenaAirdropStrategy is EthenaStrategy {
    ...
    /**
     * @notice Extracts airdropped tokens.
     * @dev Requirements:
