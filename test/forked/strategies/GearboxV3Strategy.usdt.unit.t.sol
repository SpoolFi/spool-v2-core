...
contract GearboxV3StrategyUsdtTest is TestFixture, ForkTestFixture {
    ...
    IFarmingPool sdToken = IFarmingPool(SDUSDT_TOKEN);
    uint256 toDeposit = 100000 * 10 ** 6;
    uint256 rewardTokenAmount = 4230805867981743467794;
    ...
    function test_compound() public {
        ...
        assertApproxEqAbs(compoundYieldPercentage, compoundYieldPercentageExpected, 20);
    }
