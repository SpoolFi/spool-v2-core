...
contract GearboxV3SwapStrategyCrvusdTest is TestFixture, ForkTestFixture {
    ...
    IFarmingPool sdToken = IFarmingPool(SDCRVUSD_TOKEN);
    uint256 toDeposit = 100000 * 10 ** 6;
    uint256 rewardTokenAmount = 13672346852282344051961;
